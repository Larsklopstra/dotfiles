...
sudo apt install php-mbstring php-mysql php-xml php-json php-tokenizer php-ctype php-fileinfo php-bcmath php-zip php-curl php-redis php-intl php-gd php-soap php-memcached -y
